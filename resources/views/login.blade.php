...
<head>
    ...
    <title>Anantara : Login</title>
    <link href="{{url('assets/css/bootstrap.css')}}" rel="stylesheet" media="screen">
    {{--<link href="bootstrap/css/bootstrap-theme.min.css" rel="stylesheet" media="screen">--}}
    <link rel="stylesheet" href="{{url('assets/css/login_style.css')}}" type="text/css"/>
</head>
<style>
    body {
        position: relative;
...
<div id="login-form">
    <div class="imgcontainer">
        <img src="{{url('assets/img/retinodeslogo.png')}}" alt="Avatar" height="150px"
             style="margin-top: -1%; border-radius: 40%" class="center-block"/>
    </div>
    ...
    <div class="container"
        ...
        <div class="form-group">
            ...
            <br>
            <a href="{{url('/waiter')}}" class="btn btn-success">Go to waiter login</a>
        </div>
        {!! Form::close() !!}
