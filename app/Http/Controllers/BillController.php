...
class BillController extends Controller
{
	public function index()
	{
		...
		$bills = DB::select("select id, bill_no,bill_date,grand_total,stevard,table_no,is_settle,InsertedDate, payment_mode,is_free from bill where opening_date BETWEEN '$startdt' and '$enddt' and Isdeleted=0 ORDER by bill_date DESC");
