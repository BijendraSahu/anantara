    ...
    <table class="kot_table table">
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                <span class="center_headtxt">  DHRUV VINIMAY PRIVATE LTD </span>
        ...
        <tr>
            ...
            <td colspan="2" class="right_txt letter_txt">{{$bill->discount_amt != null ? round(($net_amount+$net_amount*5/100)-$bill->discount_amt) : round($net_amount+$net_amount*5/100)}}</td>
        </tr>
